...
def titleui(p):
	...
	evc = uievent('http://127.0.0.1:5000/', title1, pyelement.onclick)
	popreg = rgisterui(p)
	params = jparams()
	...
	title2 = loginbtn(b)
	evc = uievent('http://127.0.0.1:5000/', title2, pyelement.onclick)
...
def registerbtn(b):
	...
	ev = uievent('http://127.0.0.1:5000/', title1, pyelement.onmouseover)
	...
	evo = uievent('http://127.0.0.1:5000/', title1, pyelement.onmouseout)
...
def loginbtn(b):
	...
	ev = uievent('http://127.0.0.1:5000/', title2, pyelement.onmouseover)
	...
	evo = uievent('http://127.0.0.1:5000/', title2, pyelement.onmouseout)
...
def rgisterui(p):
	...
	evchange = uievent('http://127.0.0.1:5000/', pchange, pyelement.onclick)
	params = jparams()
	onsev = on_server_response()
	...
	evunselectchange = uievent('http://127.0.0.1:5000/', pchange, pyelement.onmouseout)
	...
	evselectchange = uievent('http://127.0.0.1:5000/', pchange, pyelement.onmouseover)
	...
	evlogin = uievent('http://127.0.0.1:5000/', preg, pyelement.onclick)
	params = jparams()
...
def loginui(p, title1, title2):
	...
	evunselectreg = uievent('http://127.0.0.1:5000/', pregister, pyelement.onmouseout)
	...
	evselectreg = uievent('http://127.0.0.1:5000/', pregister, pyelement.onmouseover)
	...
	evunselectfind = uievent('http://127.0.0.1:5000/', pfind, pyelement.onmouseout)
	...
	evselectfind = uievent('http://127.0.0.1:5000/', pfind, pyelement.onmouseover)
	...
	evlogin = uievent('http://127.0.0.1:5000/', plogin, pyelement.onclick)
	params = jparams()
	params.append("checktext", pcaptchainput.pop_get_input_text())
	params.append("name", ptusernameinput.pop_get_input_text())
	params.append("key", ptusernamekeyinput.pop_get_input_text())
